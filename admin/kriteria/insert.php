...
<div class="col-md-6">
<?php
	title('success','INSERT KRITERIA','Silahkan tambah daftar kriteria');
?>
...
?>
    ...
    <tr valign="top">
      ...
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="number" step="0.01" name="profile_ideal" value="" size="32" class="form-control input-sm"/></td>
    </tr>
    <tr valign="top">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td nowrap="nowrap" align="right">&nbsp;</td>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tb_kriteria SET kode_kriteria=%s, nama_kriteria=%s, faktor_id=%s, profile_ideal=%s WHERE id_kriteria=%s",
                       ...
                       GetSQLValueString($koneksi, $_POST['profile_ideal'], "float"),
...
?>
    ...
    <tr valign="top">
      ...
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="number" step = "0.01"  name="profile_ideal" value="<?php echo htmlentities($row_rs_kriteria['profile_ideal'], ENT_COMPAT, ''); ?>" size="32" class="form-control input-sm"/></td>
    </tr>
    <tr valign="top">

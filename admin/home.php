...
<!-- Small boxes (Stat box) -->
      <div class="row">
        <div class="col-md-12">
		<?php
	  	pesan('danger','Untuk mendapatkan hasil yang baru lebih baik data di reset ulang ataupun nilai dikosongkan!');
	  ?>        
        </div>
        ...
        <div class="col-md-6 col-sm-6">
         <a href="?page=empty&reset=1" class="btn btn-warning btn-block">RESET ULANG SEMUA</a>
        </div>
        <div class="col-md-6 col-sm-6">

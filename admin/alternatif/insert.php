...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tb_alternatif (nama_alternatif, nidn, mata_kuliah) VALUES (%s, %s, %s)",
                       GetSQLValueString($koneksi, $_POST['nama_alternatif'], "text"),
                       GetSQLValueString($koneksi, $_POST['nidn'], "text"),
                       GetSQLValueString($koneksi, $_POST['mata_kuliah'], "text"));
...
<div class="col-md-5">
<?php
	title('success','INSERT NAMA','Silahkan tambah daftar NAMA');
?>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="100%" height="150">
    <tr valign="baseline">
      <td width="113" align="right" nowrap="nowrap"><div align="right">Nama</div></td>
    ...
    <tr valign="baseline">
      <td width="113" align="right" nowrap="nowrap"><div align="right">NIDN</div></td>
      <td width="10" align="right" nowrap="nowrap">&nbsp;</td>
      <td width="893"><input type="text" name="nidn" value="" size="32" class="form-control input-sm" /></td>
    </tr>
    <tr valign="baseline">
      <td width="113" align="right" nowrap="nowrap"><div align="right">Jurusan</div></td>
      <td width="10" align="right" nowrap="nowrap">&nbsp;</td>
      <td width="893"><input type="text" name="mata_kuliah" value="" size="32" class="form-control input-sm" /></td>
    </tr> 
    <tr valign="baseline">
...
<?php
	title('info','LIST NAMA','Berikut ini daftar NAMA yang telah ditambahkan');
?>
